...
export const profiles = {
    gamedev: {
        ...
        typewriterRoles: ['Game Programmer', 'Gameplay Engineer', 'Unity Developer', 'UE5 Developer'],
        heroSubtitle: 'Gameplay systems, engines, and AI. Shipped across Unity, Unreal, Godot, and MapleStory Worlds.',
        aboutSubtitle: 'Game Developer | Gameplay Programmer | Engine Programmer',
    ...
    swe: {
        ...
        typewriterRoles: ['Software Engineer', 'Backend Developer', 'Systems Programmer'],
        heroSubtitle: 'Passionate about creating elegant solutions through code, from C++ engine internals to Python services.',
    ...
    it: {
        ...
        typewriterRoles: ['IT Specialist', 'Systems Administrator', 'Automation Engineer'],
        heroSubtitle: '5+ years automating and securing IT infrastructure for 200+ user environments.',
        aboutSubtitle: 'IT Specialist | Systems Administrator | Automation Engineer',
    ...
    ai: {
        ...
        heroSubtitle: 'Machine learning and game AI, from intrusion detection models to GOAP agents in Unreal.',
    ...
    web: {
        ...
        typewriterRoles: ['Web Developer', 'Frontend Developer', 'Full Stack Developer'],
        heroSubtitle: 'Crafting modern, responsive web applications with React and Python backends.',
